        ...
        <>
            ...
            <div className='listingSection__wrap '>
                ...
                <div className='space-y-8'>
                    <h2 className='text-lg font-semibold'>Last time Details</h2>

                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-5'>
                        <FormItem label=''>
                        <Input
                                    name='dealtype'
                                    value={input.dealtype as number | undefined}
                        ...
                        <Input
                                    name='offer'
                                    value={input.offer as number | undefined}
                                    onChange={handleInputChange}
                                    type='text'
                    ...
                    <h2 className='text-lg font-semibold'>Location & Others</h2>
                    <div>
