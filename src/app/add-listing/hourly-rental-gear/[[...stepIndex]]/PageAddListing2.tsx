        ...
        <>
            ...
            <div className='listingSection__wrap '>
                <div className='space-y-8'>
                    <h2 className='text-lg font-semibold'>Location & Availability & Pricing</h2>
                    <div className='grid md:grid-cols-2 gap-8 md:gap-5'>
                    <FormItem label=''>
                            <Input
                                name='picklocation'
                                value={input.picklocation as number | undefined}
                        ...
                        <FormItem label=''>
                            <Input
                                name='returnlocation'
                                value={input.returnlocation as number | undefined}
                                onChange={handleInputChange}
                                type='text'
