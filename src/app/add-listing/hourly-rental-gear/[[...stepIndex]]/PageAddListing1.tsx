        ...
        <>
            ...
            <div className='listingSection__wrap '>
                ...
                <div className='space-y-8'>
                    <h2 className='text-lg font-semibold'>Gear Details</h2>
                    ...
                    <h2 className='text-lg font-semibold'>Location & Gear Type</h2>
                    <div>
                    ...
                    <div className='grid md:grid-cols-2 gap-8 md:gap-5'>
                        ...
                        <FormItem label=''>
                            <Input
                                name='geartype'
                                value={input.geartype as number | undefined}
                                onChange={handleInputChange}
                                type='text'
                        ...
                        <FormItem label=''>
                            <Input
                                name='condition'
                                value={input.condition as number | undefined}
                                onChange={handleInputChange}
                                type='text'
