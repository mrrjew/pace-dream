...
const Page = ({ params, searchParams }: { params: { stepIndex: string }; searchParams?: { [key: string]: string | string[] | undefined | Boolean} }) => {
  ...
  const titles = ["Choosing Roommate & Photos", "Cost Splitting Details", ""];
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append('geartype',String(input.geartype))
    formData.append('condition', String(input.condition));
    formData.append('picklocation', String(input.picklocation));
    formData.append('returnlocation', String(input.returnlocation));
