        ...
        <>
            ...
            <div className='listingSection__wrap '>
                ...
                <div className='space-y-8'>
                    <h2 className='text-lg font-semibold'>Choosing List Category</h2>

                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-5'>
                        <FormItem label=''>
                            <Select
                                name='timebased' placeholder='Time based'
                                value={input.timebased as string | undefined}
                    ...
                    <h2 className='text-lg font-semibold'>Location & Pricing model</h2>
                    <div>
                    ...
                    <div className='grid md:grid-cols-2 gap-8 md:gap-5'>
                        ...
                        <FormItem label=''>
                            <Input
                                name='rantalduration'
                                value={input.rantalduration as number | undefined}
                                onChange={handleInputChange}
                                type='text'
                                placeholder='Rantal Duration'
                            />
                        </FormItem>
                        <FormItem label=''>
                            <Input
                                name='pricingmodel'
                                value={input.pricingmodel as number | undefined}
                                onChange={handleInputChange}
                                type='text'
