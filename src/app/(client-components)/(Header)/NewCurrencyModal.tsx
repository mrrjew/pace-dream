                                    ...
                                    <div className='overflow-y-hidden rounded-2xl bg-white'>
                                        ...
                                        <div className='relative bg-white dark:bg-neutral-800 pr-[24px] pl-[24px] pt-0 pb-0 '>
                                            <p className='mb-[16px] text-sm text-gray-500'>
                                                Where applicable prices will be converted to, and shown in, the currency that you select. The
                                                currency you pay in may differ based on your reservation, and a service fee may also apply.
                                            </p>
                                            ...
                                            <div className='grid lg:grid-cols-4 gap-4 cursor-pointer'>
                                                {suggestedFor.map((item, index) => (
                                                    <a
                                                        ...
                                                        className={` p-[12px]  flex transition duration-150 ease-in-out text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 ${suggestedCurrencies.index === '' + index
                                                    ...
                                                    >
                                                        <div className='my-[4px] w-full mr-[8px] flex justify-between items-center '>
                                                            <div className='flex flex-col items-start'>
                                                                <p className=' text-sm font-medium'>{item.currencytitle}</p>
                                                            ...
                                                            {suggestedCurrencies.index === '' + index && (
                                                                <svg
                                                                    ...
                                                                    width='16'
                                                                    height='16'
                                                                    fill={suggestedCurrencies.index === '' + index ? '#3B82F6' : 'currentColor'}
                                                                >
                                            ...
                                            <h3 className='flex text-sm font-bold mb-[8px]'>All currencies</h3>
                                            <div className='grid lg:grid-cols-4 gap-5 cursor-pointer'>
                                                {allCurrencies.map((item, index) => (
                                                    <a
                                                        key={index}
                                                        onClick={() => toggleActiveAllCurrency(index)}
                                                        className={`p-[12px] flex transition duration-150 ease-in-out rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 ${allCurrenciesList.index === '' + index
                                                            ? 'bg-sky-50 dark:bg-blue-500 focus:bg-sky-50 dark:focus:bg-blue-500 text-blue-400'
                                                            : 'opacity-80'
                                                            }`}
                                                        tabIndex={0}
                                                    >
                                                        <div className='my-[4px] w-full mr-[8px] flex justify-between items-center'>
                                                            <div className='flex flex-col items-start'>
                                                                <p className=' text-sm font-medium'>{item.curencytitle}</p>
                                                                <p className=' text-sm font-medium'>{item.name}</p>
                                                            </div>
                                                            {allCurrenciesList.index === '' + index && (
                                                                <svg
                                                                    ...
                                                                    width='16'
                                                                    height='16'
                                                                    fill={allCurrenciesList.index === '' + index ? '#3B82F6' : 'currentColor'}
                                                                >
                                                                    <path d='M56.33 100a4 4 0 0 1-2.82-1.16L20.68 66.12a4 4 0 1 1 5.64-5.65l29.57 29.46 45.42-60.33a4 4 0 1 1 6.38 4.8l-48.17 64a4 4 0 0 1-2.91 1.6z'></path>
                                                                </svg>
                                                            )}
