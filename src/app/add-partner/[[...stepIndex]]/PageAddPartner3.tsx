  ...
  return (
    <>
      <div>
         ...
         <p className="mt-4">Short titles work best. Have fun with it – you can always change it later.</p>        
      </div>
      <div className="w-full border rounded-lg flex">
        <div className=" w-1/4 h-full border-r-2 my-2">
          <h2 className="px-5 py-2">Week</h2>
          <h2 className="px-5 py-2 border-l-4 border-[#444ff3] text-[#3734ee] bg-[#f5f3f3]">Month</h2>
