...
const WoodenHouseCard = () => {
  return (
    <div>
      <div className="lg:w-[296px] rounded-lg w-[340px] h-fit shadow-md cursor-pointer ">
        <Image
        ...
        <div className="flex flex-col gap-1 p-2 mt-2">
          ...
          <div className="mt-2 flex justify-between items-center">
            <p className="text-gray-600 text-lg font-medium">
              Per Day <span className="line-through">$64</span>{" "}
              <span className="text-xl text-[#632DF8] font-semibold">$32</span>{" "}
            </p>
...
export default WoodenHouseCard;
