    ...
    <div className="h-fit my-20 mx-auto w-screen ">
      <div className="mx-2 mb-4">
        <div className="flex items-center justify-between">
          <p className="font-bold text-xl">Browse by Destination</p>
      ...
      {/* <div className="flex overflow-x-scroll flex-shrink-0 flex-nowrap gap-3"> */}
      <Slider {...settings}>
        {
          BrowseByDestinationData.map((item) => (
            <div key={item.destination} className="h-[160px] w-[130px] bg-[#5527D7] rounded-lg relative">
              <Image src={item.img} fill className="rounded-lg object-cover" alt={item.destination} />
              <div className="absolute flex gap-1 items-center text-white bottom-1 left-1 font-medium">
