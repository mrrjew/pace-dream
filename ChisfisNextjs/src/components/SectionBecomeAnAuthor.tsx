    ...
    >
      <div className="relative flex-shrink-0 mb-16 lg:ml-32 lg:mb-0 lg:w-1/2 mt-4 md:mt-0 mr-8">
        <Image
          alt=""
          src={rightImg}
          className="rounded-full relative h-[22rem] w-[22rem]"
        />
      </div>
      <div className="z-10 flex-grow lg:-ml-32 text-[#192946]">
        ...
        <span className="block text-lg max-w-[80%] mt-6 text-neutral-500 dark:text-neutral-400">
          Unveil Your Reasoning: Explore the rationale behind your selection of
          stays, experiences, or rental gears. Dive into FAQs for comprehensive
          insights and answers to common queries.
        </span>
        <ButtonPrimary
          onClick={handleButtonClick}
          className="h-6 leading-2 mt-10 mb-8"
        >
          Get Answers in FAQs
        </ButtonPrimary>
      </div>
