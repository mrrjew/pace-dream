...
export function PrivacyAndSharing(){
    ...
    const privacyData = [
        ...
        },
        {
            ...
            description:"This will permanently delete your account and your data, in accordance with applicable law.",
            url: "/#",
        }
    ]
                ...
                privacyData.map((item,index,arr) => {
                    return (
                        <div key={index} className="mb-6">
                            <Link href={item.url as any} className="flex justify-between items-center gap-1 w-fit">
