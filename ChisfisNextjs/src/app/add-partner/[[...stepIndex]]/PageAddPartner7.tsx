  ...
  return (
    <>
      <div>
         ...
         <p className="mt-4">You'll add more details later, such as bed types.</p>        
      </div>

      <div className="flex gap-5">
        <button className="flex rounded-full border lg:px-10 px-6 py-2 font-medium"><MdApartment className="mt-1 mr-3"/>Only me</button>
        <button className="flex rounded-full border lg:px-10 px-6 py-2 font-medium"><FaDollyFlatbed className="mt-1 mr-3"/>Multiple person</button>
      </div>
      <div className=" w-2/4">      
      <div>
