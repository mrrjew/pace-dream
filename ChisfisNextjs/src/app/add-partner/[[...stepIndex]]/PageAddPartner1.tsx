    ...
    <>
      ...
      <div>
          <nav className="rounded-full border w-44 flex justify-between">
            ...
            <button className="rounded-full bg-[#574cf3] text-white px-6 py-3">Day</button>
          </nav>
          <div className="mt-6 flex lg:gap-4 gap-2">
            <div>
              <h3>From</h3>
                <div>
              <button className="rounded-full border lg:px-12 lg:py-3 px-7 py-3 flex justify-between">4/13/2023
            ...
            <div>
              <h3>Until</h3>
                <div>
              <button className="rounded-full border lg:px-12 lg:py-3 px-7 py-3 flex justify-between">6/13/2023
               <LiaBusinessTimeSolid className="ml-6 text-2xl"/> 
               </button>                  
                </div>
