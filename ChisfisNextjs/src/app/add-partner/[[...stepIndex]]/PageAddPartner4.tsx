  ...
  return (
    <>
      ...
      <div className="flex gap-5 flex-wrap">
        <button className="flex rounded-full border px-10 py-2 font-medium">
          <BiHotel className="mt-1 mr-3" /> Hotel
        </button>
        <button className="flex rounded-full border px-10 py-2 font-medium">
          <MdApartment className="mt-1 mr-3" /> Apartment
        </button>
        <button className="flex rounded-full border px-10 py-2 font-medium">
          <BsFillHouseAddFill className="mt-1 mr-3" /> House
        </button>
        <button className="flex rounded-full border lg:px-10 px-16 py-2 font-medium">
          <FaDollyFlatbed className="mt-1 mr-3" /> Flat
        </button>
      </div>
    </>
  );
