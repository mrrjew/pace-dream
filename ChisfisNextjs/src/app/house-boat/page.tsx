...
import houseBoatImage from "@/images/house-boat.jpg"

import HouseBoatCard from "@/components/TypesOfStay/Card2";
    ...
    return (
        <div>
            <div className="flex flex-col gap-4 pt-8 text-center bg-white " >
                <h1 className="text-4xl font-semibold tracking-tighter lg:text-5xl/none">Houseboat Hideouts</h1>
                <p className=" text-center mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                    Drift into tranquility aboard our stylish houseboats. Discover floating sanctuaries on serene lakes, winding rivers, or coastal waters. Book your aquatic oasis and embark on a unique waterborne adventure.
                </p>
            </div>
            {/* Search bar */}
            ...
            <div className="lg:px-32 py-8 px-4 flex flex-col justify-center bg-white ">
                ...
                <div className="mb-8 mt-12 flex lg:flex-row items-center flex-col lg:gap-10 gap-8 " >
                    <Image src={houseBoatImage} alt="nature" height={420} width={500} className="rounded-lg object-contain" />
                    <div className="flex flex-col gap-4" >
                        <p className="text-5xl font-semibold">
                            Aqua Retreat Oasis
                        </p>
                        <p className="text-lg">
                            Embark on a journey of serenity and adventure with Aqua Retreat Oases. These floating marvels redefine the concept of waterfront living, offering a harmonious blend of luxury and sustainability. Crafted with eco-friendly materials and innovative design, each houseboat is a testament to our commitment to preserving marine ecosystems.
                        </p>
                        <p className="text-lg">Step onto the deck of your floating sanctuary and feel the gentle sway of the water beneath you. With breathtaking views and endless horizons, Aqua Retreat Oases provide the perfect setting for a tranquil escape on the waves.</p>
                    </div>
                </div>
            </div>
        </div>
