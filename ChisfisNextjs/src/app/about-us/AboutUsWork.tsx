...
return (
    ...
    <div className="lg:grid grid-cols-3 gap-3 m-auto mt-3 p-4 sm:grid-col-2 text-center px-[50px]">
        {services.slice(0, 3).map((service) => (
            <div className='bg-white h-[380px] w-[300px] text-center p-5 rounded-xl mt-2'>
                <h3 className='text-left text-2xl ml-5 h-5 font-bold'>{service.id}</h3>
                ...
                <br />
                <h4 className='text-xl text-left mt-2 ml-4 font-semibold h-3'>{service.title}</h4>
                <br />
                <p className='text-base text-left px-4 h-15'>{service.desc}</p>
                <br />
                <h6 className='text-base text-left ml-4 font-medium h-8'>{service.Detail} &rarr; </h6>
            </div>
        ))}
    </div>
