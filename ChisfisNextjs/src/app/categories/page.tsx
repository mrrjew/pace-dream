    ...
    <div>
        ...
        {catData.map((cat: any) => {
          return (
            ...
            >
              ...
              <p className="font-bold text-sm lg:text-xl text-gray-900 text-center">
                {cat.title}
              </p>
            </Link>
          );
      ...
      <div className="flex md:flex-row mx-1 md:mx-40 flex-col items-center gap-10 p-2 md:p-4">
        ...
        >
          ...
          <h1 className="font-bold text-lg lg:text-2xl my-4 text-center">
            Do you have more questions?
          </h1>
          <p className="text-md text-center">
            An all-emcompassing and user-friendly platform that seamlessly
            connects you with precisely what you{"'"}re looking for,
            streamlining your search process effortlessly
          </p>

          <button
            onClick={shootDirectmail}
            className="px-8 py-2 md:py-4 mt-14 rounded-full bg-violet font-semibold text-white sm text-sm md:text-lg"
          >
            Shoot a Direct Mail
          </button>
        </div>
