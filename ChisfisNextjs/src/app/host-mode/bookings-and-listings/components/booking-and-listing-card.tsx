...
export function BookingAndListingCard({menus,setSelectedItem}:{
        ...
        <div className="grid grid-cols-3 gap-4 p-4 w-full rounded-2xl">
            ...
            <div className="grid grid-cols-1 col-span-2">
                <div className="flex items-center justify-between ">
                    <h2 className="text-xs md:text-lg line-clamp-1 font-semibold">Best Western Cedars </h2>
                    <Menu menuStyle={{
                        borderRadius: '0.5rem',
...
// vertical card
export function BookingAndListingVerticalCard({menus,setSelectedItem}:{ 
    setSelectedItem: (value: boolean) => void,
    menus: { title: string, onClick: () => void, className?: string }[],
}){
    ...
    return (
        <div className="grid grid-cols-1 gap-4 p-4 w-full rounded-2xl">
            <Image 
                ...
                src="https://a0.muscache.com/im/pictures/81dca5d6-5a86-49bc-8eca-4a8610a07d27.jpg?im_w=1920" 
                alt="HotelDemo1" width={300} height={360} />
            <div className="grid grid-cols-1 col-span-2 gap-4">
                ...
                <div className="flex justify-between gap-6">
                    <button className="text-sm w-full py-2 px-4 bg-gray-300 justify-center rounded-lg text-gray-500 flex
