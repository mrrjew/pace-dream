...
const CommonLayout: FC<CommonLayoutProps> = ({ children, params }) => {
  ...
  const nextHref = (index < 10 ? `/add-listing/${index + 1}` : `/`) as Route;
  ...
  return (
    <div className={`nc-PageAddListing1 px-4 max-w-3xl mx-auto pb-24 pt-14 sm:py-24 lg:pb-32`}>
      <div className='space-y-11'>
        <div>
          <span className='text-4xl font-semibold'>{index}</span> <span className='text-lg text-neutral-500 dark:text-neutral-400'>/ 10</span>
        </div>
