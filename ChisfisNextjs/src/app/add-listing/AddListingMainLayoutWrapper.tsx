  ...
  return (
    <div className="flex">
      ...
      <div className="grid grid-cols-1 flex-1 p-4 px-4 md:px-8">
        <div className="col-span-2 h-fit md:h-[70dvh]">{children}</div>
          ...
          <div className="flex justify-between  md:justify-end gap-4 items-center p-2 md:p-1">
            {!hideBackBtn && (
              <button
                ...
                className="bg-primary-100 text-black py-3 px-8 min-w-40 rounded-md disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Back
              </button>
            )}
            <button
              onClick={onNext}
              disabled={isLastStep}
              className="bg-primary-700 text-white py-3 px-4  min-w-40 rounded-md"
            >
              {submitBtnText}
            </button>
          </div>
