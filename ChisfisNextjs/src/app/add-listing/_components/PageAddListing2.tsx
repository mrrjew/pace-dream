          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            <FormItem label="">
              <Input
                ...
                onChange={(e) =>
                  updateData({ ...data, country: e?.currentTarget?.value })
                }
                name="country"
                type="text"
                placeholder="Country"
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            <FormItem label="">
              <Input
                ...
                onChange={(e) =>
                  updateData({ ...data, street: e?.currentTarget?.value })
                }
                name="street"
                type="text"
                placeholder="Street"
            ...
            <FormItem label="">
              <Input
                ...
                onChange={(e) =>
                  updateData({ ...data, city: e?.currentTarget?.value })
                }
                name="city"
                type="text"
                placeholder="City"
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
            <FormItem label="">
              <Input
                ...
                onChange={(e) =>
                  updateData({ ...data, state: e?.currentTarget?.value })
                }
                name="state"
                type="text"
                placeholder="State"
            ...
            <FormItem label="">
              <Input
                ...
                onChange={(e) =>
                  updateData({ ...data, postalCode: e?.currentTarget?.value })
                }
                name="zipcode"
                type="text"
