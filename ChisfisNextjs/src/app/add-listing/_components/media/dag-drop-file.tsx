          ...
          >
            <Dropzone.Accept>
              ...
              <div className="h-20 justify-center flex items-center gap-4">
                <CloudArrowUpIcon className="w-12 h-12 text-primary-500" />
                <p className="text-gray-400">Drop the file here</p>
              </div>
            </Dropzone.Accept>
            <Dropzone.Reject>
              <div className="h-20 justify-center flex items-center gap-4">
              ...
              <Dropzone.Idle>
                ...
                {type == "video" && (
                  <div className="h-20 flex justify-center items-center gap-4">
                    ...
                    {localMedia?.length > 0 && (
                      <RecyclingRounded className="w-12 h-12 text-gray-400" />
                    )}
                    {localMedia?.length == 0 && (
                    ...
                    {localMedia?.length == 0 && (
                      <p className="text-gray-400">
                        Upload a file or drag and drop MP4 up to 100MB
                      </p>
                    )}
                  </div>
                )}
                {type == "document" && (
                  <div className="h-20 flex justify-center items-center gap-4">
                    ...
                    {localMedia?.length > 0 && (
                      <p className="text-gray-400">
                        {localMedia?.length} document uploaded
                      </p>
                    )}
                    {localMedia?.length == 0 && (
                      <DocumentArrowDownIcon className="w-12 h-12 text-primary-500" />
                    )}
                    {localMedia?.length == 0 && (
                      <p className="text-gray-400">
                        Upload a file or drag and drop PDF up to 50MB
                      </p>
                    )}
                  </div>
                )}
