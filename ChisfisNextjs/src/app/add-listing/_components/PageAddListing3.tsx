...
const PageAddListing3 = ({
  ...
  const [bedrooms, setBedrooms] = useState<number>(
    (data?.bedroom as number) || 1,
  );
  const [bathrooms, setBathrooms] = useState<number>(
    (data?.bathroom as number) || 1,
  );
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-4">
              <FormItem label="">
                <Input
                  ...
                  onChange={(e) =>
                    updateData({ ...data, hourlyrate: e?.currentTarget?.value })
                  }
                  name="street"
                  type="text"
              ...
              <FormItem label="">
                <Input
                  ...
                  onChange={(e) =>
                    updateData({ ...data, weeklyrate: e?.currentTarget?.value })
                  }
                  name="weeklyRate"
                  type="text"
              ...
              <FormItem label="">
                <Input
                  ...
                  onChange={(e) =>
                    updateData({
                      ...data,
                      monthlyrate: e?.currentTarget?.value,
                    })
                  }
                  name="monthlyRate"
                  type="text"
              ...
              <FormItem label="">
                <Input
                  ...
                  onChange={(e) =>
                    updateData({
                      ...data,
                      cleaningfeesDaily: e?.currentTarget?.value,
                    })
                  }
