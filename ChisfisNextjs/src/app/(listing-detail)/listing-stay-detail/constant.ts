...
interface ICustomHourInputOption {
  value: number;
  label: string;
}

export const customHourInput = [
  ...
  { value: 8.5, label: '8 hours 30 minutes' },
  { value: 9, label: '9 hours' },
  { value: 9.5, label: '9 hours 30 minutes' },
  { value: 10, label: '10 hours' },
  { value: 10.5, label: '10 hours 30 minutes' },
  { value: 11, label: '11 hours' },
  { value: 11.5, label: '11 hours 30 minutes' },
  { value: 12, label: '12 hours' },
  { value: 12.5, label: '12 hours 30 minutes' },
  { value: 13, label: '13 hours' },
  { value: 13.5, label: '13 hours 30 minutes' },
  { value: 14, label: '14 hours' },
  { value: 14.5, label: '14 hours 30 minutes' },
  { value: 15, label: '15 hours' },
  { value: 15.5, label: '15 hours 30 minutes' },
  { value: 16, label: '16 hours' },
  { value: 16.5, label: '16 hours 30 minutes' },
  { value: 17, label: '17 hours' },
  { value: 17.5, label: '17 hours 30 minutes' },
  { value: 18, label: '18 hours' },
  { value: 18.5, label: '18 hours 30 minutes' },
  { value: 19, label: '19 hours' },
  { value: 19.5, label: '19 hours 30 minutes' },
  { value: 20, label: '20 hours' },
  { value: 20.5, label: '20 hours 30 minutes' },
  { value: 21, label: '21 hours' },
  { value: 21.5, label: '21 hours 30 minutes' },
  { value: 22, label: '22 hours' },
  { value: 22.5, label: '22 hours 30 minutes' },
  { value: 23, label: '23 hours' },
  { value: 23.5, label: '23 hours 30 minutes' },
