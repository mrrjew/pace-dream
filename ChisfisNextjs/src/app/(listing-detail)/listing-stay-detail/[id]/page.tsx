  ...
  const renderSection1 = () => {
    return (
      <div className="min-sm:!space-y-6">
        ...
        <div className="max-sm:pt-4 flex justify-between items-center ml-4 sm:ml-20">
            ...
            <div className="card-body">
              ...
              <div className="mt-5">
                ...
                <TabPanel>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <p>{filteredData[0].priceHour} x {selectedHour} hours</p>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="mt-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p>{filteredData[0].priceDay} x {numberOfDays} nights</p>
                        </div>
                        <div>
    ...
    <div className="bg-white w-full">
      ...
      <div className='bg-[#F9F9F9] pb-12'>
        <div className='sm:mx-20 mx-4 pt-16'>
          ...
          <div className={`grid grid-cols-1 sm:mx-20 mx-4 sm:grid sm:grid-cols-4`}>
            <div
              key={DEMO_STAYS[0].id}
