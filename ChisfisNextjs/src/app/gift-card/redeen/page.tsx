      ...
      <div className="container py-8">
        <div className="flex flex-row justify-between flex-wrap-reverse gap-6 md:space-x-44 mb-24">
          <div className="grid grid-cols-1 w-full md:w-96 gap-6">
            ...
            <input
              placeholder="PIN"
              className="ring-1 h-10 rounded-md placeholder:text-gray-500 ring-gray-300"
            />
            <p className="text-xs font-medium text-left">
              By redeeming, you agree to the 
              <Link href={"#"} className="underline">
                PaceDream Gift <br /> Card Terms
              </Link>
              .
            </p>
            <button className="bg-primary-700 text-white rounded-md w-full py-2 mt-4">
              Redeem gift card
            </button>
          </div>
