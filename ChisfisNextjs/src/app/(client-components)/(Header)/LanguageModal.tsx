...
export const suggestedLanguage = [
  {
    countryImg: 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/IN.svg',
    countryLang: 'हिन्दी',
    active: true,
  },
  {
    countryImg: 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/US.svg',
    countryLang: 'English (US)',
    active: true,
  },
  {
    countryImg: 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/FR.svg',
    countryLang: 'Français',
    active: true,
  },
  {
    countryImg: 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/CN.svg',
    countryLang: '简体中文',
    active: true,
  },
  {
    countryImg: 'https://cdn.jsdelivr.net/npm/country-flag-emoji-json@2.0.0/dist/images/DE.svg',
    countryLang: 'Deutsch',
    active: true,
  },
];
                ...
                <Dialog.Panel className='w-full max-w-5xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle transition-all'>
                  <div className='overflow-y-hidden rounded-2xl bg-white'>
                    ...
                    <div className='relative bg-white dark:bg-neutral-800 pr-[24px] pl-[24px] pt-0 pb-0 '>
                      <h3 className=' flex text-sm font-bold mb-[8px]'>Suggested for you</h3>
                      <div className='grid lg:grid-cols-4 gap-4 cursor-pointer'>
                        {suggestedLanguage.map((item, index) => (
                          <a
                            ...
                            className={` p-[12px] flex transition duration-150 ease-in-out rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 ${suggestedLanguages.index === String(index)
                          ...
                          >
                            <div className='my-[4px] w-full mr-[8px] flex justify-between items-center '>
                              <div className='flex justify-between items-center gap-3'>
                                ...
                                <p className=' text-sm font-medium'>{item.countryLang}</p>
                              </div>
                              {suggestedLanguages.index === String(index) && (
                                <svg
                                  ...
                                  width='16'
                                  height='16'
                                  fill={suggestedLanguages.index === String(index) ? '#3B82F6' : 'currentColor'}
                                >
                      ...
                      <h3 className='flex text-sm font-bold mb-[8px]'>All languages</h3>
                      <div className='grid lg:grid-cols-4 gap-5 cursor-pointer'>
                        {countryList.map((item, index) => (
                          <a
                            key={index}
                            onClick={() => toggleActiveAllLanguage(index)}
                            className={`p-[12px] flex transition duration-150 ease-in-out rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 ${allLanguageList.index === index + ''
                              ? 'bg-sky-50 dark:bg-blue-500 focus:bg-sky-50 dark:focus:bg-blue-500 text-blue-400'
                              : 'opacity-80'
                              }`}
                            tabIndex={0}
                            ...
                            <div className='my-[4px] w-full mr-[8px] flex justify-between items-center'>
                              ...
                              {allLanguageList.index === index + '' && (
                                <svg
                                  ...
                                  width='16'
                                  height='16'
                                  fill={allLanguageList.index === index + '' ? '#3B82F6' : 'currentColor'}
                                >
                                  <path d='M56.33 100a4 4 0 0 1-2.82-1.16L20.68 66.12a4 4 0 1 1 5.64-5.65l29.57 29.46 45.42-60.33a4 4 0 1 1 6.38 4.8l-48.17 64a4 4 0 0 1-2.91 1.6z'></path>
                                </svg>
                              )}
