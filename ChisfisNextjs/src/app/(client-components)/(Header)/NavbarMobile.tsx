...
const CollapsibleMenu = () => {
  ...
  return (
    <div className="fixed inset-0 h-72  w-full mt-[67px] bg-opacity-75 z-50 flex justify-end">
      <div className="flex flex-grow overflow-y-auto flex-col h-full rounded-md border-black mx-1 w-full px-36 bg-white shadow-xl">
    ...
    <>
      <article className="w-full flex items-center justify-between md:hidden relative ">
        <Image
          src={LogoMobile}
          alt="logo"
          className={`ml-4 ${hideLogo ? "hidden" : "block"}`}
        />
        {hideLogo && (
