...
const MinutesSearchForm: FC<{}> = () => {
  const [lastMinuteOption, setLastMinuteOption] =
    useState<LastMinuteOptionTypes>("tickets");
      ...
      <form className="w-full relative mt-8">
        ...
        <div className="ml-4 mt-4 md:hidden">
          <h2 className="max-w-[75%] text-left font-semibold md:hidden text-3xl">
            Discover Your Perfect Match: Book Rooms, Find Roommates, and Secure
            Last-Minute Deals Effortlessly!
          </h2>
        </div>
        <div className="flex flex-col flex-1 mx-8 mt-8 py-4 md:border items-center gap-4 md:flex-row rounded-lg">
          ...
          <GuestsInput
            className="flex-[1.5]"
            buttonSubmitHref={`/listing-stay-map/5?term=${lastMinuteOption}`}
          />
        </div>
      </form>
    </div>
