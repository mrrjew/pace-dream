  ...
  const renderInput = () => {
    return (
      <div className="flex-grow text-left max-md:mt-4 max-md:ml-4 md:mr-4">
        ...
        <span
          className={`flex flex-row border p-2 h-11 max-md:w-[85vw] md:p-2 lg:p-3 xl:p-2 ${dates} rounded-lg mt-1 text-base text-neutral-400 items-center justify-between leading-none cursor-pointer font-light`}
        >
          Male
        </span>
      </div>
  ...
  const renderOutput = () => {
    return (
      <div className="flex-grow text-left max-md:mt-2 max-md:ml-4">
        <span
          className={`flex flex-row border h-11 p-2 max-md:w-[85vw] md:p-2 lg:p-3 xl:p-2 ${dates} rounded-lg mt-1 text-base text-neutral-400 items-center px-4 cursor-pointer justify-between leading-none font-light`}
        >
          Female
        </span>
      </div>
