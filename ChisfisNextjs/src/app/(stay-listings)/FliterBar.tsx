...
const FilterBar = ({
  ...
  params: FilterBarProps;
  onParamChanges?: (params: FilterBarProps) => void;
  onSearch?: (query: FilterBarProps) => void;
  isLoading?: boolean;
}) => {
  ...
  return (
    <div className="bg-white flex justify-between p-2 gap-6 md:p-5 rounded-xl container">
      ...
      <div className="flex">
        ...
        <div className="space-y-1 lg:space-y-2">
          <label htmlFor="location" className="text-sm text-transparent">
            Availability{" "}
          </label>
