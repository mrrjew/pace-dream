...
import natureHouseImage from "@/images/nature-house.jpg";
    ...
    <div>
      <div className="flex flex-col gap-4 pt-8 text-center bg-white ">
        ...
        <p className=" text-center mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
          Find your perfect nature retreat. Book a cozy cabin, a lakeside
          cottage, or a mountain chalet.
        </p>
      </div>
      {/* Search bar */}
      ...
      <div className="lg:px-32 py-8 px-4 flex flex-col justify-center bg-white ">
        ...
        <div className="mb-8 mt-12 flex lg:flex-row items-center flex-col lg:gap-10 gap-8 ">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-5xl font-semibold">Nature House Retreat</p>
            <p className="text-lg">
              Immerse yourself in a lifestyle that harmonizes with nature at our
              Nature Houses. Tucked away amidst serene surroundings, these
              eco-friendly dwellings redefine modern living with a commitment to
              sustainability.Each residence is meticulously crafted to minimize
              environmental impact, boasting energy-efficient features and
              locally-sourced materials.
            </p>
            <p className="text-lg">
              Step outside and discover a world of natural wonders right on your
              doorstep. From lush gardens to tranquil trails, Nature Houses
              offer residents the opportunity to reconnect with the great
              outdoors.
            </p>
          </div>
        </div>
