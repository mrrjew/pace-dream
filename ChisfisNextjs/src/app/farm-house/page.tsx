    ...
    <div>
      <div className="flex flex-col gap-4 pt-8 text-center bg-white ">
        ...
        <p className=" text-center mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
          Immerse yourself in rural serenity with our collection of farmhouse
          getaways. Experience the simplicity and beauty of farm life while
          staying in a quaint farmhouse, barn conversion, or rural retreat.
        </p>
      </div>
      {/* Search bar */}
      ...
      <div className="lg:px-32 py-8 px-4 flex flex-col justify-center bg-white ">
        ...
        <div className="mb-8 mt-12 flex lg:flex-row items-center flex-col lg:gap-10 gap-8 ">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-5xl font-semibold">Farmstead Harmony Haven</p>
            <p className="text-lg">
              Experience the beauty of country living at Farmstead Harmony
              Havens. Tucked away in picturesque landscapes, these farmhouses
              offer a retreat from the hustle and bustle of modern life. Built
              with a focus on sustainability
            </p>
            <p className="text-lg">
              Step outside your farmhouse retreat and breathe in the fresh air
              of the countryside. With sprawling fields to explore and peaceful
              orchards to roam
            </p>
          </div>
        </div>
