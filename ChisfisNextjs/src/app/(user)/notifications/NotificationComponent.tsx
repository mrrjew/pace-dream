...
const NotificationComponent = () => {
  ...
  const getIcon = (type: string) => {
    ...
    if(type.includes('payment')) return <CreditCardIcon className="w-8 h-8 text-[#3c49f3]" />
    if(type.includes('booking')) return <CalendarIcon className="w-8 h-8 text-[#3c49f3]" />
