...
const data = [
  {
    ...
    additional: "hi@pacedream.com",
  },
  {
    icons: HiOutlineLocationMarker,
    title: "Office",
    description: "Come say hello at our office HQ.",
    additional: "100 Smith Street Collingwood VIC 3066 AU",
  },
  {
    icons: FiPhone,
    title: "Phone",
    description: "Mon-Fri 8am-5pm",
    additional: "+61 3 9417 0150",
  },
];
  ...
  return (
    <>
      ...
      <div className="lg:px-36 lg:py-20 py-10 px-4 grid lg:grid-cols-3 grid-cols-1 gap-8 text-center bg-[#fbf9fe]">
        {data.map((item) => (
          <div key={item.title} className="flex flex-col items-center shadow-sm hover:shadow-md rounded-xl py-4">
